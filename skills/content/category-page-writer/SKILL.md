---
name: category-page-writer
description: When the user wants to write copy for an e-commerce category or collection page. Also use when the user mentions "category page," "collection page copy," or "category description." For individual product pages, use product-page-optimizer.
metadata:
  version: 1.0.0
---
...
Category/collection page copy. Not individual product descriptions (see **product-page-optimizer**).
...
1. Confirm the category's hierarchy position and its target keyword.
2. Draft a brief above-the-grid intro (1–2 sentences).
3. Draft longer, keyword-relevant descriptive copy for below the grid, covering what the category is, how to choose within it, and links to relevant subcategories.
4. Confirm filter/sort functionality doesn't get pushed down by copy placement.
5. Check internal linking to and from related categories and top products.

## Related Skills

- **product-page-optimizer**: Individual product page, one level down from this category scope
- **internal-linking-strategy** (on-page): Broader linking strategy this page's links should follow
