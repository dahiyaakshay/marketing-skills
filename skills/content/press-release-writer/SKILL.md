...
description: When the user wants to draft a press release for an announcement. Also use when the user mentions "press release," "announcement copy," or "PR draft." For pitching that release to journalists, use digital-pr-pitch-writer (off-page category).
metadata:
  version: 1.0.0
---
...
The release document itself. Not the outreach/pitch to journalists (see **digital-pr-pitch-writer**, off-page category).
...
| **Contact info** | Media contact name, email, phone |
...
5. Attach standard boilerplate and contact info.
6. Hand off to **digital-pr-pitch-writer** for the journalist outreach angle.

## Related Skills

- **digital-pr-pitch-writer** (off-page): Outreach built around this release
- **brand-mention-monitor** (off-page): Tracking pickup after distribution
