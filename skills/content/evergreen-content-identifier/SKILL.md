---
name: evergreen-content-identifier
description: When the user wants to determine whether a planned or existing piece of content will stay relevant long-term versus needing frequent updates. Also use when the user mentions "evergreen content," "will this age well," or "content that doesn't need constant updating." For maintaining content once published, use content-refresh-audit. For scheduling publication cadence, use content-calendar-builder.
metadata:
  version: 1.0.0
---
...
Classifying topics/content by decay rate. Not the maintenance workflow itself once a page is live (see **content-refresh-audit**) or calendar sequencing (see **content-calendar-builder**).
...
| Signal | Likely evergreen | Likely time-sensitive |
|---|---|---|
...
1. Apply the three-year test to the candidate topic.
...
- **content-refresh-audit**: Ongoing maintenance workflow, still needed even for evergreen classifications
- **content-calendar-builder**: Where evergreen vs. time-sensitive classification informs scheduling priority
- **pillar-page-strategy**: Pillar pages should generally be evergreen topics, given the maintenance investment they warrant
