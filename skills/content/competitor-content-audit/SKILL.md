...
description: When the user wants an ongoing view of what competitors are publishing and how their content strategy is evolving. Also use when the user mentions "competitor content audit," "what are competitors publishing," or "competitor content strategy." For a point-in-time gap check on a specific topic, use content-gap-analysis.
metadata:
  version: 1.0.0
---
...
Ongoing, broad competitor monitoring. Not a single-topic keyword gap check (see **content-gap-analysis**), which this audit's findings often feed into.
...
- **content-gap-analysis**: Deep, single-topic follow-up once this audit flags a competitive threat
- **content-calendar-builder**: Where competitive findings typically influence prioritization
- **rank-tracking-summary**: Confirms whether competitor content actually displaced the site in rankings
