...
description: When the user wants to find new link building opportunities broadly, beyond just competitor gaps. Also use when the user mentions "link prospecting," "find link opportunities," or "who should we reach out to for links." For competitor-specific gap analysis, use competitor-backlink-gap. For the actual outreach messaging, use guest-post-outreach or digital-pr-pitch-writer.
metadata:
  version: 1.0.0
---
...
Broad-based link opportunity identification. For the competitor-referenced-domain method specifically, see **competitor-backlink-gap**. For actual outreach execution, see **guest-post-outreach**, **digital-pr-pitch-writer**, or **haro-response-writer**.
...
1. Select the prospecting method(s) appropriate to the site's content and industry.
2. Generate a raw prospect list using the relevant search patterns.
3. Filter for relevance, legitimacy, and realistic acquisition likelihood.
4. Categorize each prospect by the appropriate acquisition method (guest post, mention-to-link conversion, HARO-style response, direct outreach).
5. Hand off to the matching outreach skill for execution.

## Related Skills

- **competitor-backlink-gap**: Narrower, competitor-referenced-domain prospecting method
- **guest-post-outreach**, **digital-pr-pitch-writer**, **haro-response-writer**: Execution skills for prospects identified here
- **backlink-audit**: Quality filter this skill applies to prospects
